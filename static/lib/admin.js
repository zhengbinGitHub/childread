...
layui.define('view', function(exports){
  ...
  element.on('tab('+ FILTER_TAB_TBAS +')', function(data){
    let layHref = data.elem.find('li')[data.index].getAttribute('lay-attr');
    localStorage.setItem('layHref',layHref)
  ...
  $body.on('click', '*[lay-href]', function(){
    ...
    var oldRouter = JSON.parse(localStorage.getItem('pageRouter')) ||[]
    oldRouter.push(window.location.href)
    localStorage.setItem('pageRouter',JSON.stringify(oldRouter))
