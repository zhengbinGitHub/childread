<div class="layui-fluid">
    <div class="layui-card-body C-marginTop-10">
        <form class="layui-form base_form" action='[[urlfor "admin.TopicController.Put" ":id" .Info.Id]]' method="post">
        ...
        [[.xsrfdata]]
          <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" name="url" value="[[.Info.Url]]" required  lay-verify="required" placeholder="请输入连接" autocomplete="off" class="layui-input col-xs-10">
                </div>
              </div>
          <div class="layui-form-item">
            <label class="layui-form-label">显示</label>
            <div class="layui-input-block">
              <input type="checkbox" [[if eq .Info.Status 1]]checked[[end]] value="[[.Info.Status]]" name="status" lay-skin="switch">
            </div>
          </div>
