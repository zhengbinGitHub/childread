    <form class="layui-form layui-card-body bgc-f2f C-border-10"  id="search-form">
        <div class="layui-form-item">
            <div class="layui-col-md4 layui-col-xs4 fl-row-center C-marginTop-10">
                <input type="text" name="name" maxlength="20" value="[[.Name]]" placeholder="标签搜索" autocomplete="off"
    ...
    <div id='addAlert' hidden>
        <div class='layui-form layui-card-body C-border-10'>
            <div  class="fl-row-leftNowrap " >
                <span class='layui-col-md4'>标签名称:</span>
                <div class=" layui-input-inline layui-col-md8">
                    <input type="text"  name="title" required  lay-verify="required" placeholder="请输入标签名称" autocomplete="off" class="layui-input alert-ipt">
                </div>
            </div>
        </div>
    </div>
    <div class="layui-card-body C-marginTop-10">
        <div class="layui-btn-container">
            <span class="layui-btn" id='addSource'>添加标签</span>
        </div>
        <table  lay-filter="table-hide" style="display: none" lay-data="{height:'full-310',height: 600, cellMinWidth: 80,toolbar: '#toolbar', limit: [[.Page_size]] }">
            ...
            [[range .Lists]]
                <tr>
                    ...
                    <td>
                        <a class="G-color-blue C-cursor-pointer C-paddingLr-5" onclick="admin.confirmPopup('确认删除吗？','[[urlfor "admin.TagController.Delete" ":id" .Id]]')">删除</a>
