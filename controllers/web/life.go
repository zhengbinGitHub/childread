...
// LifeController operations for Life
type LifeController struct {
	BaseController
}

//子类
func (c *LifeController) NestPrepare() {
	c.Data["InfoPath"] = "life"
}
...
// @Param	body		body 	models.Life	true		"body for Life content"
// @Success 201 {object} models.Life
// @Failure 403 body is empty
// @router / [post]
func (c *LifeController) GetList() {
...
// GetOne ...
// @Title GetOne
// @Description get Life by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Life
